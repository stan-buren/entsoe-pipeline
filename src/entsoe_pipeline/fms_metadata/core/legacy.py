...
from entsoe_pipeline import PHYSICAL_CATALOG_DIR, get_classifier_config
...
def ingest_legacy_metadata(archive_name: str) -> None:
    ...
    """
    logger.info(
        "=== STARTING MULTI-ENVIRONMENT HISTORICAL %s METADATA EXPLORATION ===",
        archive_name.upper(),
    )
    ...
    logger.info("=" * 60)
    logger.info("         MULTI-ENVIRONMENT LEGACY COMPARISON SUMMARY    ")
    logger.info("=" * 60)
    logger.info(
