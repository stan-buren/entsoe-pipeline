...
"""ENTSO-E FMS OtherMarketInformation Domain Metadata Ingestion Module.

This script acts as a declarative orchestrator for the OtherMarketInformation
domain metadata ingestion process by delegating core logic to the central
ingestion engine.
"""
...
logger = logging.getLogger(
    "entsoe_pipeline.fms_metadata.other_market_information_ingest"
)
