...
def _():
    ...
    for word in words:
        print(
            f"This is the word: {word}\n"
            f"This is a length: {len(word)}"
            , end="\n\n"
        )
    return
...
def _():
    def _():
        ...
        large_users = {f"user_{i}": ("active" if i % 2 == 0 else "inactive") for i in range(100_000)}
...
def _():
    ...
    large_user_log = [f"user_{random.randint(1, 100_000_000)}" for _ in range(10_000_000)]
